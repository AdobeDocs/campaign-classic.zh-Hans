...
* 每个链接编辑工具一个过滤器（请参阅使用链接编辑器[创建过滤器）,](#creating-a-filter-using-a-link-editor)
...
1. 创建单个&#x200B;**[!UICONTROL Page]** Web 应用程序，并禁用出站过渡和过渡到下一页。
...
1. 在Web 应用程序属性中，通过选择&#x200B;**[!UICONTROL Single-page Web application]**&#x200B;模板来修改应用程序的呈现。

   ![](assets/s_ncs_configuration_webapp_rendering.png)

1. 打开Web 应用程序的&#x200B;**[!UICONTROL Page]**&#x200B;活动并打开列表(**[!UICONTROL Static element > List]**)。
1. 在列表的&#x200B;**[!UICONTROL Data]**&#x200B;选项卡中，选择&#x200B;**[!UICONTROL Web applications]**&#x200B;文档类型和&#x200B;**[!UICONTROL Label]**、**[!UICONTROL Creation date]**&#x200B;和&#x200B;**[!UICONTROL Type of application]**&#x200B;输出列。
...
1. 使用&#x200B;**folder**&#x200B;值更改变量名称。
   ...
   >[!NOTE]
   >
   >变量的名称必须与链接到文件夹(在模式中定义)的元素的名称匹配，即&#x200B;**文件夹**。 引用表时，必须重新使用此名称。
...
1. 将光标放在列表上，在&#x200B;**[!UICONTROL Advanced]**&#x200B;选项卡中，引用先前在列表的&#x200B;**[!UICONTROL Folder filter XPath]**&#x200B;选项卡中创建的变量。 必须使用文件夹链接所关注元素的名称，即&#x200B;**folder**。
...
1. 修改标签。
   ...
   它将显示在概述中的&#x200B;**[!UICONTROL Filter]**&#x200B;字段旁。
...
Web 应用程序现已配置。 单击&#x200B;**[!UICONTROL Preview]**&#x200B;选项卡可预览它。
