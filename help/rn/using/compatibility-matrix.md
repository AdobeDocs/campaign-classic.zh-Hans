...
从Campaign v7.4开始，Campaign SDK已[弃用](deprecated-features.md)。 要确保现有实施平稳过渡到AEP Mobile SDK，您仍然可以在下面列出的操作系统上使用它<!--, using the associated [mobile SDK](../../delivery/using/integrating-campaign-sdk-into-the-mobile-application.md)-->。
