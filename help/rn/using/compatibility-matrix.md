...
>[!IMPORTANT]
>
>使用RHEL，您必须愿意禁用[SELinux](../../installation/using/prerequisites-of-campaign-installation-in-linux.md#selinux)，或者让架构师编写自定义SELinux规则来检查启用的SELinux是否不会导致Campaign操作问题。
