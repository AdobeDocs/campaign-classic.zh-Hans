...
新Vertica analyticsFDA连接器 —  [了解更多](../../installation/using/configure-fda-vertica.md)
...
以下技术说明已更新：[SMS 连接器协议和设置](https://helpx.adobe.com/campaign/kb/sms-connector-protocol-and-settings.html)。
