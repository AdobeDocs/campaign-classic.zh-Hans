...
从Campaign Classic 19.2开始，状态将关联到每个内部版本。 您将在状态列表、状态的含义和相关图像下找到：

![](assets/green2.png)**一**&#x200B;般可用性：最新稳定版本可用。

![](assets/blue2.png)**候**&#x200B;选释放：由Adobe验证，等待生产校样。

![](assets/orange2.png)**不**&#x200B;再可用：更新版本可用，需要更新。

![](assets/green3.png)**一**&#x200B;般可用性：最新稳定版本可用。

![](assets/blue3.png)**候**&#x200B;选释放：由Adobe验证，等待生产校样。

![](assets/orange3.png)**不**&#x200B;再可用：更新版本可用，需要更新。
...
<table> 
 <tbody> 
  <tr> 
   ...
   <td>此版本已经由Adobe验证。  等待生产校样。</td>
  </tr> 
  <tr> 
   <td><img src="assets/orange.png"/></td> 
   <td>不再可用</td>
   <td>此版本不存在重大问题，但有较新的版本提供了其他错误修复。 需要更新。</td>
  </tr> 
 </tbody> 
</table>
...
<tr>
  <td>
    ...
    <div>
    <img src="assets/green3.png"/><strong>一般可用性</strong>
    </div>
    <p>
    <em>提供最新的稳定版本。</em>
    <p>
  ...
  <td>
    ...
    <p>
    <em>此版本已经由Adobe验证。 等待生产校样。</em>
    <p>
  </td>
   <td>
    <img src="assets/update.png" />
    <div>
    <img src="assets/orange3.png"/><strong>不再可用</strong>
    </div>
    <p>
    <em>此版本不存在重大问题，但有较新的版本提供了其他错误修复。 需要更新。</em>
    <p>
  </td>
</tr>
</table>
...
| 其他资源： |  |
|--- |--- |
| [升级到最新版本](https://helpx.adobe.com/campaign/kb/acc-build-upgrade.html) | [控制面板发行说明](https://docs.adobe.com/content/help/en/control-panel/using/release-notes.html) |
| [最新文档更新](../../rn/using/documentation-updates.md) | [以前的发行说明](../../rn/using/release--19-1.md) |
