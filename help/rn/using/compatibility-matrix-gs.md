...
product: campaign
title: Gold Standard 兼容性矩阵
description: Gold Standard 版本的 Campaign Classic 兼容性矩阵
audience: rns
...
本文档列出针对 **Adobe Campaign Classic Gold Standard** 19.1 内部版本支持的所有系统和组件。此列表中未包含的产品和版本与 Adobe Campaign 不兼容。
