...
### 18.10.1 版 - 版本 8977{#release-18-10-build-8977}
...
### 18.6.1 版 - 版本 8947{#release-18-6-build-8947}
...
的 **decryptPassword** 函数。 它允许您解密存储在外部帐户中的密码。 请参阅 [JSAPI](https://helpx.adobe.com/campaign/kb/compatibility-matrix.html) 文档以了解更多信息。
...
### 18.4.1 版 - 版本 8931{#release-18-4-build-8931}
