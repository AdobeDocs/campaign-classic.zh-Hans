...
<table> 
 <tbody>
  ...
  <tr>  
   <td>传真渠道<br></td>
   <td><p>从 Campaign 21.1.3 版本开始，不再使用传真渠道。<a href="https://experienceleague.adobe.com/docs/campaign/campaign-v8/send/create-message.html?lang=zh-Hans" target="_blank">请参阅Campaign v8文档以了解详情</a></p>
  </tr>
  <tr>
  <td>Demdex 域<br></td>
