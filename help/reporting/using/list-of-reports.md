...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> 每个电子邮件域的统计信息(已处理邮件、已传送邮件、硬弹回、软弹回、点击、退订)。<br /> </td> 
   <td> nms:投放<br /> </td> 
  </tr> 
  <tr> 
   <td> 共享活动统计信息(forwardActivity)<br /> </td> 
   <td> 分析每个时间段共享活动、打开次数和订阅。<br /> </td> 
   <td> nms:投放<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 投放指标摘要：目标、排除和已发送的消息。<br /> </td> 
   <td> nms:投放<br /> </td> 
  </tr> 
  <tr> 
   <td> 投放摘要(deliveryStatistics)<br /> </td> 
   <td> 所选投放的摘要表：目标、排除和已发送的消息。<br /> </td> 
   <td> nms:投放<br /> </td> 
  </tr> 
  <tr> 
...
有关活动的报告与&#x200B;**nms:operation**&#x200B;表中的数据有关。
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td> 用户活动符(operationRecipientActivity)<br /> </td> 
   <td> 按时间段划分打开、单击和事务，具体取决于活动。<br /> </td> 
  </tr> 
  <tr> 
   <td> 投放吞吐量(operationThroughput)<br /> </td> 
   <td> 投放吞吐量图表（以邮件／小时和Mbits/s为单位）取决于活动。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 共享活动和邮件打开统计信息，取决于活动。<br /> </td> 
  </tr> 
  <tr> 
   <td> 假设验证报告(operationHexposition)<br /> </td> 
   <td> 显示假设验证投放的活动度量摘要，具体取决于活动。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 活动投放的摘要图表：目标、排除和已发送的消息。<br /> </td> 
  </tr> 
  <tr> 
   <td> URL并单击吞吐量(operationTopUrlDelivery)<br /> </td> 
   <td> 大多数反应式URL和关联的单击流取决于活动。<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td> 风扇获取(socialAccubrationsByWebapp)<br /> </td> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> 预算费用按承付款水平的变化。<br /> </td> 
   <td> nms:budget<br /> </td> 
  </tr> 
  <tr> 
   <td> 预算的累积演化(budgetCumulativeEvolution)<br /> </td> 
   <td> 按公司职等划分的累积预算费用的演变。<br /> </td> 
   <td> nms:budget<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> 排除的所有原因的详细表。<br /> </td> 
  </tr> 
  <tr> 
   <td> 按等级划分优惠(offerSimulationRanking)<br /> </td> 
  ...
  <tr> 
   <td> 因模拟(dlvSimuLossSimu)引起的排除摘要<br /> </td> 
   <td> 由模拟引起的排除表。<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td> 答复的细分(surveyDistribution)<br /> </td> 
   <td> 问题答复的细分。<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> 优惠分析/日期和渠道，取决于“交互”加载项。<br /> </td> 
   <td> nms:优惠<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> Twitter和Facebook潜在客户获取的历史记录取决于社交营销加载项。<br /> </td> 
   <td> nms:访客<br /> </td> 
  </tr> 
  <tr> 
