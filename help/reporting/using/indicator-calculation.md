...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> 打开<br /> </td> 
   <td> @opens<br /> </td> 
   <td> URL主键@totalClicks等于1的所有值的总和。<br /> </td> 
   <td> sum(Iif([@url-id]=1, @totalClicks, 0)<br /> </td> 
  </tr> 
  <tr> 
   <td> 单击<br /> </td> 
   <td> @clicks<br /> </td> 
   <td> URL类型@totalClicks等于“Email click”的所有URL总和。<br /> </td> 
...
此报告基于&#x200B;**[!UICONTROL Consolidated tracking]**&#x200B;表(nms:trackingStats)。 此聚合表用于显示报告时的性能原因，它取代了&#x200B;**[!UICONTROL Recipient tracking logs]**&#x200B;表(nms:trackingLogRcp)，并且不会实时计算。 在检索跟踪日志后几分钟内会生成表。 如果指标是最新的，则结果与&#x200B;**跟踪指标**&#x200B;报告的指标相同。 @totalclicks指示器表示在5分钟内的点击总数。
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 状态等于“已就绪”、“已发送”或“失败”的消息总和。<br /> </td> 
  ...
  <tr> 
   ...
   <td> Count(@status=2, msg/@failureReason=1)<br /> </td> 
  </tr> 
  <tr> 
   <td> 无法访问<br /> </td> 
...
报告的第二部分详细说明了按互联网域（而不是错误类型）划分失败消息的情况。 在此例中，链接到&#x200B;**Error**&#x200B;指示器(@value)的公式为：Count(@status=2 and @domain=&quot;域名的值&quot;)，即此域状态失败的所有消息的计数。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 页面查看次数<br /> </td> 
   <td> @totalPages<br /> </td> 
   <td> 使用此浏览器进行所有投放的投放链接的总点击次数。<br /> </td> 
   <td> Sum(@pages)<br /> </td> 
  </tr> 
  <tr> 
   <td> 使用率<br /> </td> 
   <td> -<br /> </td> 
   <td> 此浏览器的访客百分比与访客总数的比较。<br /> </td> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> 使用率<br /> </td> 
   <td> @visitors<br /> </td> 
   <td> 使用此浏览器的每日访客数与在访问次数最多的当天测量的访客数的百分比。<br /> </td> 
   <td> percent(sum(@visitors),max(@visitorsOfTheDay)<br /> </td> 
  </tr> 
  <tr> 
   <td> 全局速率<br /> </td> 
   <td> -<br /> </td> 
   <td> 此版本的访客百分比与使用所有浏览器的访客总数之比。<br /> </td> 
   <td> percent(@totalVisitors, @globalVisitors)<br /> </td> 
  </tr> 
  <tr> 
   <td> 相对重量<br /> </td> 
   <td> -<br /> </td> 
   <td> 此版本的访客百分比与使用此浏览器的访客总数之比。<br /> </td> 
   <td> 百分比(@totalVisitors, sum(@totalVisitors)<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> Facebook<br /> </td> 
   <td> @facebook<br /> </td> 
   <td> URL类@totalClicks等于“facebook”的所有值的总和。<br /> </td> 
   <td> Sum(iIf([url/@category]='facebook',@totalClicks,0))<br /> </td> 
  </tr> 
  <tr> 
   <td> Twitter<br /> </td> 
   <td> @twitter<br /> </td> 
   <td> URL类@totalClicks等于“twitter”的所有值的总和。<br /> </td> 
   <td> Sum(iIf([url/@category]='twitter',@totalClicks,0))<br /> </td> 
  </tr> 
  <tr> 
   <td> 美味的<br /> </td> 
   <td> @delicious<br /> </td> 
   <td> URL类@totalClicks等于“delicious”的所有值的总和。<br /> </td> 
   <td> Sum(iIf([url/@category]='delicious',@totalClicks,0))<br /> </td> 
  </tr> 
  <tr> 
   <td> Digg<br /> </td> 
   <td> @digg<br /> </td> 
   <td> URL类@totalClicks等于“digg”的所有值的总和。<br /> </td> 
   <td> Sum(iIf([url/@category]='digg',@totalClicks,0))<br /> </td> 
  </tr> 
  <tr> 
   <td> Google<br /> </td> 
   <td> @google<br /> </td> 
   <td> URL类@totalClicks等于“google”的所有值的总和。<br /> </td> 
   <td> Sum(iIf([url/@category]='google',@totalClicks,0))<br /> </td> 
  </tr> 
  <tr> 
   <td> Linkedin<br /> </td> 
   <td> @linkedin<br /> </td> 
   <td> URL类@totalClicks等于“linkedin”的所有值的总和。<br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 打开率<br /> </td> 
   <td> @rateOpen<br /> </td> 
   <td> 此社交网络上的打开次数与要传递的消息总数之比。<br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 共享<br /> </td> 
   <td> @shared<br /> </td> 
   <td> “电子邮件”、“facebook”、“twitter”、“可口”、“digg”、“google”、“linkedin”<br />包含URL类别的URL类别，该类别等于“email”、“facebook”、“twitter”、“delicios”、“digg”、“google”或“linkedin”。<br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 所有投放的每个操作系统的投放链接的每日平均点击次数。<br /> </td> 
   <td> Sum(@pages)<br /> </td> 
  </tr> 
  <tr> 
   <td> 使用率<br /> </td> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> 使用率<br /> </td> 
   <td> @visitors<br /> </td> 
   <td> 此操作系统中每日访客数与在访问次数最多的当天测量的访客数的百分比。<br /> </td> 
   <td> percent(sum(@visitors), max(@visitorsOfTheDay)<br /> </td> 
  </tr> 
  <tr> 
   <td> 全局速率<br /> </td> 
   <td> -<br /> </td> 
   <td> 每个版本的访客百分比与所有操作系统的访客总数之比。<br /> </td> 
   <td> percent(@totalVisitors, @globalVisitors)<br /> </td> 
  </tr> 
  <tr> 
   <td> 相对速率<br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 进化<br /> </td> 
   <td> -<br /> </td> 
   <td> 订阅数减去取消订阅数。 该速率与订阅者总数有关。<br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 达到<br />的群体上会打开不同的 </td> 
   <td> @estimatedRecipientOpen<br /> </td> 
   <td> 根据html格式电子邮件的非重复打开数量推断所有电子邮件的非重复打开数。<br /> </td> 
  ...
  <tr> 
   ...
   <td> 根据html格式的电子邮件总打开数推断所有电子邮件的总打开数。<br /> </td> 
  ...
  <tr> 
   <td> 转发估计<br /> </td> 
   <td> @forward<br /> </td> 
   <td> 独特访客数量与点击了电子邮件至少一次的不同收件人数量之间的差异。<br /> </td> 
  ...
  <tr> 
   <td> 投诉<br /> </td> 
   <td> @complaints<br /> </td> 
   <td> 状态等于“失败”且原因等于“上的地址”的阻止列表消息计数。<br /> </td> 
   <td> Count(@status=2, msg/@failureReason=8)<br /> </td> 
  </tr> 
  <tr> 
   <td> 打开<br /> </td> 
  ...
  <tr> 
   <td> 原始反应性<br /> </td> 
   <td> -<br /> </td> 
   <td> 点击投放至少一次的收件人数量与打开投放至少一次的收件人数量的百分比。<br /> </td> 
   <td> percent(@recipientClick,@recipientOpen)<br /> </td> 
  </tr> 
  <tr> 
   <td> 对达到的群体的非重复点击<br /> </td> 
   <td> @personClick<br /> </td> 
   <td> URL类@source-ids等于“Email click”的所有计数。<br /> </td> 
   <td> Countdistinct(Iif([url/@type]=1, @source-id, 0))<br /> </td> 
  </tr> 
  <tr> 
   <td> 累计的点击量<br /> </td> 
   <td> @totalRecipientClick<br /> </td> 
   <td> URL类@ids等于“Email click”的所有计数。<br /> </td> 
   <td> count(Iif([url/@type]=1, @id, 0))<br /> </td> 
  </tr> 
  <tr> 
   <td> 收件人点击<br /> </td> 
   <td> @recipientClick<br /> </td> 
   <td> URL类型等于“Email click”@broadLog-ids的非重复计数。<br /> </td> 
   <td> Countdistinct(Iif([url/@type]=1, @broadLog-id, 0))<br /> </td> 
  </tr> 
  <tr> 
   <td> 估计反应性<br /> </td> 
   <td> -<br /> </td> 
   <td> 点击了投放至少一次的收件人数目与至少打开该投放一次的收件人估计数的比率。<br /> </td> 
   <td> percent(@recipientClick, @estimatedRecipientOpen<br /> </td> 
  </tr> 
  <tr> 
   <td> 已访问页面<br /> </td> 
   <td> @totalWebPage<br /> </td> 
   <td> URL类型@ids等于“Web”或“Transaction”的所有计数。<br /> </td> 
   <td> count(Iif([url/@type]=4或[url/@type]=5, @id, 0))<br /> </td> 
  </tr> 
  <tr> 
   <td> 事务<br /> </td> 
   <td> @transaction<br /> </td> 
   <td> URL类型@ids等于“Transaction”的所有计数。<br /> </td> 
  ...
  <tr> 
   <td> 平均交易金额<br /> </td> 
   <td> -<br /> </td> 
   <td> 总金额与交易次数的比率。<br /> </td> 
   <td> div(@amount, @transaction<br /> </td> 
  </tr> 
  <tr> 
   <td> 项目<br /> </td> 
   <td> @article<br /> </td> 
   <td> URL类型等于“Transaction”的WebTrackingLog/@articles总和。<br /> </td> 
  ...
  <tr> 
   <td> Facebook<br /> </td> 
   <td> @facebook<br /> </td> 
   <td> URL类@totalClicks等于“facebook”的所有URL总和。<br /> </td> 
   <td> Sum(iIf([url/@category]='facebook',@totalClicks,0))<br /> </td> 
  </tr> 
  <tr> 
   <td> Twitter<br /> </td> 
   <td> @twitter<br /> </td> 
   <td> URL类@totalClicks等于“twitter”的所有URL总和。<br /> </td> 
   <td> Sum(iIf([url/@category]='twitter',@totalClicks,0))<br /> </td> 
  </tr> 
  <tr> 
   <td> 美味的<br /> </td> 
   <td> @delicious<br /> </td> 
   <td> URL类@totalClicks等于“delicious”的所有URL总和。<br /> </td> 
   <td> Sum(iIf([url/@category]='delicious',@totalClicks,0))<br /> </td> 
  </tr> 
  <tr> 
   <td> Digg<br /> </td> 
   <td> @digg<br /> </td> 
   <td> URL类@totalClicks等于“digg”的所有URL总和。<br /> </td> 
   <td> Sum(iIf([url/@category]='digg',@totalClicks,0))<br /> </td> 
  </tr> 
  <tr> 
   <td> Google<br /> </td> 
  ...
  <tr> 
   <td> Linkedin<br /> </td> 
   <td> @linkedin<br /> </td> 
   <td> URL类@totalClicks等于“linkedin”的所有URL总和。<br /> </td> 
   <td> Sum(iIf([url/@category]='linkedin',@totalClicks,0))<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> 反应性<br /> </td> 
   <td> @reactivity<br /> </td> 
   <td> 点击了至少一次投放的目标收件人数量与至少打开一次投放的预计目标收件人数量的比率。<br /> </td> 
   <td> percent([指标/@recipientClick], [指标/@estimatedRecipientOpen]<br /> </td> 
  </tr> 
  <tr> 
   <td> 非重复单击<br /> </td> 
   <td> @distinctClicks<br /> </td> 
   <td> 至少点击一次投放的独特访客数与成功投放的消息数之比。<br /> </td> 
   <td> percent([指标/@personClick], [指标/@success]<br /> </td> 
  </tr> 
  <tr> 
   <td> 累计的点击量<br /> </td> 
   <td> @totalClicks<br /> </td> 
   <td> 目标收件人点击总次数与成功投放消息数量之比。<br /> </td> 
   <td> percent([指标/@totalRecipientClick], [指标/@success]<br /> </td> 
  </tr> 
  <tr> 
   <td> 单击<br /> </td> 
   <td> @_click<br /> </td> 
   <td> URL主键与@totalClicks 1<br />不同的所有URL计数 </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 规则<br />拒绝的消息 </td> 
   <td> @reject<br /> </td> 
   <td> 在分析过程中根据分类规则忽略的地址数：未指定、隔离、阻止列表等的地址<br /> </td> 
   <td> sum([属性/@reject]<br /> </td> 
  </tr> 
  <tr> 
   <td> 要传送的消息<br /> </td> 
   <td> @toDeliver<br /> </td> 
   <td> 投放分析后要投放的邮件总数。<br /> </td> 
   <td> sum([属性/@toDeliver]<br /> </td> 
  </tr> 
  <tr> 
   <td> 成功<br /> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 单击<br /> </td> 
   <td> @clicks<br /> </td> 
   <td> URL类型等@totalClicks于“Email click”的所有URL总和。<br /> </td> 
   <td> sum(Iif([url/@type] = 1, @totalClicks, 0))<br /> </td> 
  </tr> 
  <tr> 
   <td> 打开<br /> </td> 
   <td> @opens<br /> </td> 
   <td> URL主@totalClicks键等于1的所有值的总和。<br /> </td> 
   <td> sum(Iif([@url-id] = 1, @totalClicks, 0)<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> 软退回<br /> </td> 
   <td> @softBounce<br /> </td> 
   <td> 状态等于“失败”且原因等于“不可访问”、“收件箱已满”、“域名无效”、“已禁用帐户”、“未连接”或“已拒绝”的所有消息总数<br /> </td> 
