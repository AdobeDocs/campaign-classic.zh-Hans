...
1. 批准投放。
   ...
   请参阅审 [批流程](../../campaign/using/marketing-campaign-approval.md#approval-process)。
...
您可以通过活动创建活动列表。 要显示此视图，请选 **[!UICONTROL Campaigns]** 择仪表板中的菜 **[!UICONTROL Campaigns]** 单。

![](assets/s_ncs_user_add_an_op_from_list.png)

通 **[!UICONTROL Program]** 过该字段，您可以选择要附加项目的活动。 此信息是强制性的。

![](assets/s_ncs_user_new_op_wz_a.png)

活动也可以通过项目创建。 为此，请单击相 **[!UICONTROL Add]** 关项目 **[!UICONTROL Schedule]** 选项卡中的按钮。

![](assets/s_ncs_user_add_an_op.png)

当您通过活动的选 **[!UICONTROL Schedule]** 项卡创建项目时，活动会自动链接到相关项目。 在此 **[!UICONTROL Program]** 情况下，该字段处于隐藏状态。
...
>[!NOTE]
>
>要筛选要显示的活动，请单 **[!UICONTROL Filter]** 击链接，然后选择要显示的活动的状态。
...
## 周期活动 {#recurring-and-periodic-campaigns}
...
#### 为重复活动创建模板 {#creating-the-campaign-template}
...
1. 对于此类活动，会添 **[!UICONTROL Schedule]** 加一个选项卡以创建模板执行计划。
...
1. 在字段中指 **[!UICONTROL Create in advance for]** 定一个值，为指示的期间创建相应的工作流。
1. 根据此模板创建要在活动中使用的工作流模板，其中包含定位参数和一个或多个通用投放。

   >[!NOTE]
   >
   >此工作流必须保存为循环工作流模板。 为此，请编辑工作流属性，并在选 **[!UICONTROL Recurring workflow template]** 项卡中选 **[!UICONTROL Execution]** 择选项。

   ![](assets/s_ncs_user_op_template_recur_wf_option.png)

#### 创建重复活动 {#create-the-recurring-campaign}
...
1. 重复工作流是从活动中出现的工作流模板自动创建的。 它们可在活动 **[!UICONTROL Targeting and workflows]** 的选项卡中显示。
