...
[讨论](../../campaign/using/discussion-forums.md) 概述论坛在Adobe Campaign的运作方式。
...
* 如果资源是通过营销资源创建任务管理的，则在将任务设置为&#x200B;**[!UICONTROL Finished]**&#x200B;时执行该资源，只要在任务中选中&#x200B;**[!UICONTROL Publish the marketing resource]**&#x200B;框（请参阅[营销资源创建任务](../../campaign/using/creating-and-managing-tasks.md#marketing-resource-creation-task)）
