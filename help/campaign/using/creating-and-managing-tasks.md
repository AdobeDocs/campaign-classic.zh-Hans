...
### 管理员和参与者{#manager-and-participants}
...
可以向任务中添加文档和营销资源（有关更多信息，请参阅[管理营销资源](../../campaign/using/managing-marketing-resources.md)）。 要执行此操作，请打开任务并单击任务工具栏中的&#x200B;**[!UICONTROL Documents]**&#x200B;图标。
...
>[!NOTE]
>
>有关费用和预算的进一步信息，请参见[成本承诺、计算和费用](../../campaign/using/controlling-costs.md#cost-commitment--calculation-and-charging)。
...
>[!NOTE]
>
>管理预算和成本的方法在[控制成本](../../campaign/using/controlling-costs.md)中介绍。
...
### 链接到程序{#task-linked-to-a-program}的任务
...
#### 任务与其链接的资源{#interaction-between-the-task-and-its-linked-resource}之间的交互
