...
* **本地营销活动**
   ...
   请参阅[创建本地营销活动](../../campaign/using/creating-a-local-campaign.md)。
...
* **协作活动**
   ...
   * **[!UICONTROL Collaborative campaign (simple)]**:此模式可确保与先前版本的特定执行进程兼容。
   ...
   请参阅[创建协作型营销活动](../../campaign/using/creating-a-collaborative-campaign.md)。
...
>[!NOTE]
>
>审批流程请参见[审批流程](../../campaign/using/creating-a-local-campaign.md#approval-process)一节。
