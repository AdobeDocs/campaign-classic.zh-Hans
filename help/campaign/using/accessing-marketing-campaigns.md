...
促销活动元素位于 **[!UICONTROL Campaigns]** 选项卡：您可以在此处查看营销计划、营销活动及其子集的概述。 营销计划由营销活动组成，营销活动由投放、任务、链接资源等组成。 在使用Campaign进行营销活动管理的上下文中，有关投放、预算、审阅人和链接文档的信息可在营销活动中找到。
...
营销活动可集中处理一组投放。 对于每个活动，计划提供了所有组件的全局视图：您可以显示任务和投放并轻松访问它们。
...
* 定义成本：对于每个活动，Adobe Campaign允许您定义 [成本录入和成本计算结构](../../campaign/using/providers--stocks-and-budgets.md#defining-cost-categories) 可在创建营销活动时使用的区段。 例如：印刷费、使用外部机构、房间租金。
