...
>[!CAUTION]
>
>请勿修改应用程序的标准架构，而是使用架构扩展机制。 否则，在应用程序未来升级时，修改的架构将不会更新。 这可能导致使用Adobe Campaign时出现故障。
...
### 使用Adobe Campaign收件人{#response-management-with-adobe-campaign-recipients}管理响应
