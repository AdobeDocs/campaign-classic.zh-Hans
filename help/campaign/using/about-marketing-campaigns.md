...
# 编排营销活动{#designing-marketing-campaigns}
...
要了解有关营销活动管理的更多信息，请参阅[Campaign v8文档](https://experienceleague.adobe.com/docs/campaign/campaign-v8/campaigns/campaigns.html?lang=zh-Hans){target=_blank}。

![](assets/do-not-localize/campaign.jpg){width="40%"}

了解与营销活动管理相关的关键步骤：

* [入门](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/set-up-campaigns.html?lang=zh-Hans){target=_blank}：逐步了解如何在Adobe Campaign中创建和执行营销活动。

* [创建您的第一个营销活动](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-create.html?lang=zh-Hans){target=_blank}：了解如何计划和设置逻辑以编排营销活动。 营销策划可集中与营销策划相关的所有元素：投放、定位规则、成本、导出文件、相关文档等。

* [在营销活动中发送消息](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-deliveries.html?lang=zh-Hans){target=_blank}：在营销活动中编排跨渠道投放：通过个性化电子邮件、短信、推送通知和应用程序内消息简化与Adobe Campaign的通信。

![](assets/do-not-localize/add-on.jpg){width="40%"}

有三种加载项可用于营销活动管理：

* [营销活动优化](https://experienceleague.adobe.com/docs/campaign/automation/campaign-optimization/campaign-typologies.html?lang=zh-Hans){target=_blank}：此模块允许您控制、筛选和监视投放的发送。 这可确保所发送的邮件符合客户的需求与期望以及公司的通信政策。

* [营销资源管理](https://experienceleague.adobe.com/docs/campaign/automation/mrm/about-marketing-resource-management.html?lang=zh-Hans){target=_blank}：此模块允许您在协作模式下控制营销操作，方法是提供所涉及的任务、预算和营销资源的完整管理和实时跟踪。

* [分布式营销](https://experienceleague.adobe.com/docs/campaign/automation/distributed-marketing/about-distributed-marketing.html?lang=zh-Hans){target=_blank}：此模块允许您在协作模式下控制营销操作，方法是提供所涉及的任务、预算和营销资源的完整管理和实时跟踪。
