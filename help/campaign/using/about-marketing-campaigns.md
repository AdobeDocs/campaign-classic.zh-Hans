...
* [分布式营销](https://experienceleague.adobe.com/docs/campaign/automation/distributed-marketing/about-distributed-marketing.html?lang=zh-Hans){target=_blank}：此模块允许您在协作模式下控制营销活动，方法是提供所涉及任务、预算和营销资源的完整管理和实时跟踪。
