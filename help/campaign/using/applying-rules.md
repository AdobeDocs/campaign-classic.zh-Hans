...
## 对投放{#applying-a-typology-to-a-delivery}应用分类
...
>[!NOTE]
>
>对于筛选规则，您可以选择筛选条件的应用条件：它们可以依赖投放或投放大纲。 有关更多信息，请参阅[Conditioning a filtering rule](../../campaign/using/filtering-rules.md#conditioning-a-filtering-rule)。
...
>有关分布式营销的更多信息，请参阅[关于分布式营销](../../campaign/using/about-distributed-marketing.md)。
