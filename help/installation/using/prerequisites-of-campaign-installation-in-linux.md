...
* Apache，请参见[兼容性矩阵](../../rn/using/compatibility-matrix.md),
...
* LibreOffice，请参阅[Installing LibreOffice for Debian](#installing-libreoffice-for-debian)和[Installing LibreOffice for CentOS](#installing-libreoffice-for-centos),
* 字体，请参阅[Fonts for MTA statistics](#fonts-for-mta-statistics)和[Fonts for Japanese实例](#fonts-for-japanese-instances)。
...
[兼容性矩阵](../../rn/using/compatibility-matrix.md)中详细描述了支持的导频版本。
...
>[!NOTE]
>
>如果您已经安装了Oracle客户端，但安装了全局环境(例如：/etc/profile)配置不正确，您可以向&#x200B;**nl6/customer.sh**&#x200B;脚本中添加缺失信息。有关更多信息，请参阅[环境变量](../../installation/using/installing-packages-with-linux.md#environment-variables)。
...
* 步骤1:安装应用程序服务器，请参阅[在Linux](../../installation/using/installing-packages-with-linux.md)中安装包。
