...
安装测试完成后，通过 **[!UICONTROL Start > Programs > Adobe Campaign]** ，然后输入以下命令：
...
下载LibreOffice，例如从 [https://www.libreoffice.org/download/libreoffice-fresh/](https://www.libreoffice.org/download/libreoffice-fresh/) 并按常规安装步骤操作。
