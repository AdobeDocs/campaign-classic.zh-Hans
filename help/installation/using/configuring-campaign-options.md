...
subfeature_v2: id: cebd7cfa-b9fa-4d9f-a2ab-fce31f32c4a3id: cfc95e9b-b035-4403-a6a9-b27a8a053a37id: eff19c99-440a-4318-b319-444edc4d8d8f
...
**[!UICONTROL Administration / Platform / Options]**&#x200B;节点允许您配置Adobe Campaign选项。 其中一些是在安装Campaign时内置的，而其他则可以在需要时手动添加。 可用选项因随实例一起安装的软件包而异。
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 上次从可投放性实例检索的broadLogMsg的日期。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">Deliverability_LastBroadLogMsgSent</span> <br /> </td> 
   <td> 上次发送到可投放性实例的broadLogMsg日期。<br /> </td> 
  </tr> 
  <tr> 
...
<tr> 
  ...
  <tr> 
   ...
   <td> 为使投放被视为计费报告中的主要投放而允许的最小收件人数。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 准备投放期间，插入broadLogs的批次大小加倍的批次持续时间阈值（毫秒数）。<br /> </td> 
  </tr> 
  <tr> 
 ...
 <tr> 
  ...
  <tr> 
   ...
   <td> 如果用户留空，则在实例级别用于电子邮件投放的默认“回复”电子邮件标签。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsEmail_RetryCount</span> <br /> </td> 
   <td> 电子邮件两次重试之间的周期（以秒为单位）。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> “lineImage”servlet中用于编码URL的AES键（LINE通道）。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsNPAI_EmailMaxError</span> <br /> </td> 
   <td> 在渠道“电子邮件”（用作默认值） ：在将收件人隔离之前发送期间出现的SOFT错误的最大可接受错误数。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsNPAI_EmailSignalErrorDelay</span> <br /> </td> 
   <td> 渠道“电子邮件”（用作默认值） ：在计及新的SOFT错误之前，自上次引用的SOFT错误以来的最短逗留时间。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsNPAI_MobileMaxError</span> <br /> </td> 
   <td> 在渠道“移动设备”上：在发送期间将收件人隔离之前的SOFT错误接受的最大错误数。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsNPAI_MobileSignalErrorDelay</span> <br /> </td> 
   <td> 在渠道“移动”上：考虑新的SOFT错误之前，自上次引用的SOFT错误以来的最短逗留时间。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 将执行SMS消息重试的时段。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsUserAgentStats_LastConsolidation</span> <br /> </td> 
   <td> <span class="uicontrol">NmsUserAgent</span>统计数据的上次合并日期。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 启用/禁用对Code128.<br />的特殊字符的支持 </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 在Adobe Campaign客户端控制台中发布资源的位置。 请参阅<a href="../../delivery/using/formatting.md#image-referencing">此部分</a>.<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NcmResourcesDirPreview</span> <br /> </td> 
   <td> 在Adobe Campaign客户端控制台中用于预览的资源位置。 请参阅<a href="../../delivery/using/formatting.md#image-referencing">此部分</a>.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 允许您配置用于上传图像的实例名称。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsDelivery_MediaPassword</span> <br /> </td> 
   <td> 允许您配置用于上传图像的密码。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsDelivery_MediaServers</span> <br /> </td> 
   <td> 允许您配置用于上传图像的媒体URL。<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 将在导出的报告右上角显示的徽标。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">NmsServer_PausedWorkflowPeriod</span> <br /> </td> 
   <td> 检查暂停的工作流之间要等待的天数。<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 如果选择1，则此选项会在文件下载期间禁用ACL控件（通过fileDownload.jsp）。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 输入“1”值，以通过在删除记录之前修改其“修改者”字段来跟踪删除mData中带有审核记录信息的元素。<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> <span class="uicontrol">MC_ExtensionCustomJs</span> <br /> </td> 
   <td> JavaScript库将进行个性化以丰富活动。 必须包含这两个函数的实现：<br /> 
    <ul> 
     <li> <p> <span class="uicontrol">extendsRtEvents(aiEventId)；</span> ：扩充并保存数据库中的事件（其中<span class="uicontrol">aiEventId</span>对应于已处理的实时事件表）。</p> </li> 
     <li> <p> <span class="uicontrol">enrichedBatchEvents(aiEventId)；</span> ：扩充并储存资料库中的事件（其中<span class="uicontrol">aiEventId</span>对应至已处理批次事件的ID表）。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> JavaScript库将针对路由事件进行个性化。 必须包含这两个函数的实现：<br /> 
    <ul> 
     <li> <p> <span class="uicontrol">dispatchRtEvent(iEventId)；</span> ：返回选定用于处理实时事件的事务性消息的内部名称（其中<span class="uicontrol">iEventId</span>对应于已处理的实时事件的ID）。</p> </li> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> Adobe Campaign实例的时区。 查看<a href="../../installation/using/time-zone-management.md#configuration" target="_blank">配置</a>.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 在迁移过程中，树结构会根据新版本标准自动重新组织。<br /> 使用此选项可禁用导航树的自动迁移。 如果使用它，迁移后必须删除过时的文件夹，添加新文件夹并运行所有必要的检查。<br /> 
    ...
    </ul> 仅当现成的导航树更改太多时，才应使用此选项。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 有关升级后发生错误的信息，请遵循以下语法：<br /> <strong>{Build number}：{mode： pre/post/...}：{发生错误的“lessThan”/“greaterOrEquelThan”+子步骤}</strong> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">XtkCleanup_NoStats</span> <br /> </td> 
   <td> 输入“1”值，以便不通过清理工作流执行统计更新。<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 允许您在迁移后继续使用旧的未声明的SQL函数。 我们强烈建议不要使用此选项，因为它会带来安全风险。<br /> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 指针跟踪通过其ID和日期处理的最后一个消息事件。<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 如果选择了选项1，则必须在第二步中在界面中手动确认删除。 否则，将删除数据而不进行确认。<br /> </td> 
  </tr> 
  <tr> 
   <td> <span class="uicontrol">Privacy_Request_ConfirmDeletePendingDelay</span> <br /> </td> 
   <td> 请求等待删除确认与请求之间的延迟已取消。<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> 启用LDAP服务器以验证用户并向用户提供授权。<br /> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 在“其他服务器”模式下用于Web窗体失效的实例密码。<br /> </td> 
  </tr> 
  <tr> 
