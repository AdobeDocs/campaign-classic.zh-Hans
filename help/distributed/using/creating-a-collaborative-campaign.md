...
**本地实体分发** 必须创建type data distribution。 通过数据分发模板，您可以限制分组值列表中的记录数。 In **[!UICONTROL Resources > Campaign management > Data distribution]**，单击 **[!UICONTROL New]** 图标以新建 **[!UICONTROL Data distribution]**. 有关数据分发的更多信息，请参阅 [工作流](../../workflow/using/using-the-local-approval-activity.md#step-1--creating-the-data-distribution-template-) 指南。
