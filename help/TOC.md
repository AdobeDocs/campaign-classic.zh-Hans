...
+ 快速入门 {#getting-started}
   ...
   + {hide-from-toc}[使用Campaign Explorer — 隐藏](platform/using/adobe-campaign-explorer.md)
   ...
   + {hide-from-toc}[词汇表 — 隐藏](platform/using/ac-glossary.md)
   + 隐私 {#privacy}
   ...
   + 轮廓管理 {#profile-management}
      ...
      + {hide-from-toc}[编辑个人资料 — 隐藏](platform/using/editing-a-profile.md)
      + {hide-from-toc}[添加配置文件 — 隐藏](platform/using/adding-profiles.md)
      + {hide-from-toc}[管理配置文件 — 隐藏](platform/using/managing-profiles.md)
      + [更新数据](platform/using/updating-data.md)
      + {hide-from-toc}[导入和导出用户档案 — 隐藏](platform/using/exporting-and-importing-profiles.md)
   ...
   + 筛选数据 {#filtering-data}
      ...
      + {hide-from-toc}[创建筛选器 — 隐藏](platform/using/creating-filters.md)
   ...
   + CRM 连接器 {#connectors}
      ...
      + {hide-from-toc}[与Microsoft Dynamics 365连接](platform/using/crm-ms-dynamics.md)
      + {hide-from-toc}[与Salesforce.com连接](platform/using/crm-sfdc.md)
      + {hide-from-toc}[与CRM同步数据](platform/using/crm-data-sync.md)
...
+ 创建和发送消息 {#sending-messages}
   ...
   + 快速入门 {#key-steps-when-creating-a-delivery}
      + {hide-from-toc}[开始投放 — 隐藏](delivery/using/steps-about-delivery-creation-steps.md)
      + {hide-from-toc}[创建并识别投放 — 隐藏](delivery/using/steps-create-and-identify-the-delivery.md)
   ...
   + 发送电子邮件 {#sending-emails}
      ...
      + {hide-from-toc}[定义电子邮件内容 — 隐藏](delivery/using/defining-the-email-content.md)
      ...
      + 发送电子邮件投放 {#sending-an-email}
         ...
         + {hide-from-toc}[在日本手机上发送 — 隐藏](delivery/using/sending-emails-on-japanese-mobiles.md)
   ...
   + 发送短信 {#sending-messages-on-mobiles}
      ...
      + {hide-from-toc}[迁移到扩展通用SMPP连接器](delivery/using/unsupported-connector-migration.md)
   ...
   + 个性化投放 {#personalizing-deliveries}
      ...
      + {hide-from-toc}[生成个性化的PDF文档 — 隐藏](delivery/using/generating-personalized-pdf-documents.md)
...
+ 编排营销活动 {#orchestrating-campaigns}
   ...
   + 编排营销活动 {#orchestrate-campaigns}
      + {hide-from-toc}[营销活动入门 — 隐藏](campaign/using/setting-up-marketing-campaigns.md)
      ...
      + {hide-from-toc}[监控您的营销活动 — 隐藏](campaign/using/marketing-campaign-monitoring.md)
      + {hide-from-toc}[提供商、库存和预算 — 隐藏](campaign/using/providers-stocks-and-budgets.md)
   + 活动优化 {#campaign-optimization}
      + {hide-from-toc}[关于营销活动类型 — 隐藏](campaign-opt/using/about-campaign-typologies.md)
      + {hide-from-toc}[压力规则 — 隐藏](campaign-opt/using/pressure-rules.md)
      + {hide-from-toc}[一致性规则 — 隐藏](campaign-opt/using/consistency-rules.md)
      + {hide-from-toc}[控件规则 — 隐藏](campaign-opt/using/control-rules.md)
...
+ 分布式营销 {#distributed-marketing}
   ...
   + {hide-from-toc}[创建本地营销活动 — 隐藏](distributed/using/creating-a-local-campaign.md)
   ...
   + {hide-from-toc}[访问营销活动 — 隐藏](distributed/using/accessing-campaigns.md)
   + {hide-from-toc}[跟踪营销活动 — 隐藏](distributed/using/tracking-a-campaign.md)
...
+ 与 Adobe Experience Cloud 集成 {#integrating-with-adobe-experience-cloud}
   ...
   + ACS 连接器 {#acs-connector}
      + {hide-from-toc}[开始使用 [!DNL ACS Connector]  — 隐藏](integrations/using/acs-connector-principles-and-data-cycle.md)
      + {hide-from-toc}[同步用户档案 — 隐藏](integrations/using/synchronizing-profiles.md)
      + {hide-from-toc}[同步受众 — 隐藏](integrations/using/synchronizing-audiences.md)
      + {hide-from-toc}[同步Web应用程序 — 隐藏](integrations/using/synchronizing-web-applications.md)
...
+ 使用工作流实现自动化 {#automating-with-workflows}
   + 工作流入门 {#introduction}
      ...
      + {hide-from-toc}[生成工作流 — 隐藏](workflow/using/building-a-workflow.md)
   ...
   + 执行工作流 {#executing-a-workflow}
      + {hide-from-toc}[启动工作流 — 隐藏](workflow/using/starting-a-workflow.md)
   ...
   + 目标选择活动 {#targeting-activities}
      + {hide-from-toc}[关于定位活动 — 隐藏](workflow/using/about-targeting-activities.md)
      ...
      + {hide-from-toc}[合并 — 隐藏](workflow/using/union.md)
      + {hide-from-toc}[交集 — 隐藏](workflow/using/intersection.md)
      + {hide-from-toc}[排除项 — 隐藏](workflow/using/exclusion.md)
      + {hide-from-toc}[拆分 — 隐藏](workflow/using/split.md)
      + {hide-from-toc}[单元格 — 隐藏](workflow/using/cells.md)
      + {hide-from-toc}[单元格优惠 — 隐藏](workflow/using/offers-by-cell.md)
      ...
      + {hide-from-toc}[优惠引擎 — 隐藏](workflow/using/offer-engine.md)
      ...
      + {hide-from-toc}[CRM连接器 — 隐藏](workflow/using/crm-connector.md)
   ...
   + 流量控制活动 {#flow-control-activities}
      ...
      + {hide-from-toc}[AND — 加入 — 隐藏](workflow/using/and-join.md)
      + {hide-from-toc}[计划程序 — 隐藏](workflow/using/scheduler.md)
      ...
      + {hide-from-toc}[跳转（起点和终点 — 隐藏）](workflow/using/jump-start-point-and-end-point.md)
   ...
   + 操作活动 {#action-activities}
      ...
      + {hide-from-toc}[数据加载（文件） — 隐藏](workflow/using/data-loading-file.md)
      + {hide-from-toc}[内容管理 — 隐藏](workflow/using/content-management.md)
      + {hide-from-toc}[数据提取（文件） — 隐藏](workflow/using/extraction-file.md)
      + {hide-from-toc}[SQL代码和JavaScript代码 — 隐藏](workflow/using/sql-code-and-javascript-code.md)
      + {hide-from-toc}[SQL数据管理 — 隐藏](workflow/using/sql-data-management.md)
      + {hide-from-toc}[Nlserver模块 — 隐藏](workflow/using/nlserver-module.md)
      + {hide-from-toc}[更新聚合 — 隐藏](workflow/using/update-aggregate.md)
   + 事件活动 {#event-activities}
      ...
      + {hide-from-toc}[Web下载 — 隐藏](workflow/using/web-download.md)
      + {hide-from-toc}[入站电子邮件 — 隐藏](workflow/using/inbound-emails.md)
      + {hide-from-toc}[入站SMS — 隐藏](workflow/using/inbound-sms.md)
   + 用例 {#use-cases}
   ...
   + 监控 {#monitoring}
      ...
      + {hide-from-toc}[监督您的工作流 — 隐藏](workflow/using/supervising-workflows.md)
   ...
   + 数据管理 {#data-management}
      ...
      + {hide-from-toc}[使用聚合 — 隐藏](workflow/using/using-aggregates.md)
   ...
   + 查询和筛选 {#query-and-filter-hidden}
      ...
      + {hide-from-toc}[执行聚合计算 — 隐藏](workflow/using/performing-aggregate-computing.md)
      + {hide-from-toc}[使用分组管理进行查询 — 隐藏](workflow/using/querying-using-grouping-management.md)
      + {hide-from-toc}[使用多对多关系进行查询 — HIDDEN](workflow/using/querying-using-many-to-many-relationship.md)
      + {hide-from-toc}[添加明细列表类型计算字段 — HIDDEN](workflow/using/adding-enumeration-type-calculated-field.md)
      + {hide-from-toc}[创建筛选器 — 隐藏](workflow/using/creating-a-filter.md)
      + {hide-from-toc}[筛选重复的收件人 — 隐藏](workflow/using/filtering-duplicated-recipients.md)
   + 监测工作流 {#monitoring-workflows}
      + {hide-from-toc}[监视工作流执行 — 隐藏](workflow/using/monitoring-workflow-execution.md)
      + {hide-from-toc}[监视技术工作流 — 隐藏](workflow/using/monitoring-technical-workflows.md)
   ...
   + 高级管理 {#advanced-management}
      ...
      + {hide-from-toc}[JavaScript脚本和模板 — 隐藏](workflow/using/javascript-scripts-and-templates.md)
      + {hide-from-toc}[工作流中的JavaScript代码示例 — 隐藏](workflow/using/javascript-in-workflows.md)
...
+ 安装和配置指南 {#installing-campaign-classic}
   ...
   + 配置 Campaign {#additional-configurations}
      ...
      + {hide-from-toc}[在Campaign中使用MX服务器](installation/using/using-mx-servers.md)
   ...
   + 附录 {#appendices}
      ...
      + {hide-from-toc}[卸载营销活动](installation/using/uninstalling-campaign.md)
...
+ 迁移指南 {#migrating-to-a-new-version}
   + {hide-from-toc}[迁移到Adobe Campaign v7](migration/using/about-migration.md)
   + 迁移过程 {#migration-procedure}
      ...
      + {hide-from-toc}[调整您的配置](migration/using/configuring-your-platform.md)
   + 开始迁移 {#migrating-to-adobe-campaign-7}
      + {hide-from-toc}[迁移Microsoft Windows平台](migration/using/migrating-in-windows-for-adobe-campaign-7.md)
      + {hide-from-toc}[迁移Linux平台](migration/using/migrating-in-linux-for-adobe-campaign-v7.md)
...
+ 技术说明 {#technotes}
   ...
   + 升级和兼容性{#technote-migration}
      ...
      + {hide-from-toc}[新可投放性服务器](technotes/using/deliverability-server.md)
      + {hide-from-toc}[Apache安全升级](technotes/using/acc-apache-upgrade.md)
      + {hide-from-toc}[2023系统升级](technotes/using/tech-stack-upgrade.md)
      + {hide-from-toc}[IMS更新](technotes/using/ims-updates.md)
      + {hide-from-toc}[TLS 1.0和1.1支持生命周期结束](technotes/using/eol-tls-support.md)
   + 电子邮件和推送通知{#technotes-email}
      ...
      + {hide-from-toc}[在ISP中断后更新不正确的硬退回](delivery/using/update-bounces.md)
      + [iOS 证书更新](technotes/using/ios-certificate-update.md)
      + {hide-from-toc}[跟踪的URL更新](technotes/using/tracked-urls.md)
