...
+ 创建和发送消息 {#sending-messages}
   ...
   + 发送电子邮件 {#sending-emails}
      ...
      + [定义电子邮件的内容 - 隐藏](delivery/using/defining-the-email-content.md)
   ...
   + 发送推送通知 {#sending-push-notifications}
      ...
      + 配置移动应用程序{#configure-the-mobile-app}
         ...
         + [iOS 配置步骤 - 隐藏](delivery/using/configuring-the-mobile-application.md)
         + [Android 配置步骤 - 隐藏](delivery/using/configuring-the-mobile-application-android.md)
      + 创建推送通知{#create-a-push-msg}
         + [创建 iOS 推送消息 - 隐藏](delivery/using/create-notifications-ios.md)
         + [创建 Android 推送消息 - 隐藏](delivery/using/create-notifications-android.md)
   ...
   + 个性化投放 {#personalizing-deliveries}
      ...
      + [生成个性化 PDF 文档 - 隐藏](delivery/using/generating-personalized-pdf-documents.md)
...
+ 编排营销活动 {#orchestrating-campaigns}
   ...
   + 编排营销活动 {#orchestrate-campaigns}
      + [营销活动快速入门 - 隐藏](campaign/using/setting-up-marketing-campaigns.md)
   ...
   + 活动优化 {#campaign-optimization}
      ...
      + [一致性规则 - 隐藏](campaign-opt/using/consistency-rules.md)
...
+ 分布式营销 {#distributed-marketing}
   ...
   + [发布营销活动包 - 隐藏](distributed/using/publishing-the-campaign-package.md)
   + [访问活动 - 隐藏](distributed/using/accessing-campaigns.md)
...
+ 使用工作流实现自动化 {#automating-with-workflows}
   ...
   + 执行工作流 {#executing-a-workflow}
      + [开始工作流 - 隐藏](workflow/using/starting-a-workflow.md)
   ...
   + 目标选择活动 {#targeting-activities}
      ...
      + [CRM 连接器 - 隐藏](workflow/using/crm-connector.md)
   ...
   + 流量控制活动 {#flow-control-activities}
      ...
      + [和连接 - 隐藏](workflow/using/and-join.md)
      + [调度程序 - 隐藏](workflow/using/scheduler.md)
   ...
   + 操作活动 {#action-activities}
      ...
      + [定期投放 - 隐藏](workflow/using/recurring-delivery.md)
      ...
      + [正在加载数据（文件）- 隐藏](workflow/using/data-loading-file.md)
      + [内容管理 - 隐藏](workflow/using/content-management.md)
      + [数据提取（文件）- 隐藏](workflow/using/extraction-file.md)
      + [SQL 代码和 JavaScript 代码 - 隐藏](workflow/using/sql-code-and-javascript-code.md)
      + [SDL 数据管理 - 隐藏](workflow/using/sql-data-management.md)
      + [Nlserver 模块 - 隐藏](workflow/using/nlserver-module.md)
      + [更新总计 - 隐藏](workflow/using/update-aggregate.md)
   + 事件活动 {#event-activities}
      ...
      + [Web 下载 - 隐藏](workflow/using/web-download.md)
      + [入站电子邮件 - 隐藏](workflow/using/inbound-emails.md)
      + [入站短信 - 隐藏](workflow/using/inbound-sms.md)
   + 用例 {#use-cases}
   ...
   + 数据管理 {#data-management}
      ...
      + [使用总计 - 隐藏](workflow/using/using-aggregates.md)
      + [使用重复数据删除活动的合并功能 - 隐藏](workflow/using/deduplication-merge.md)
   ...
   + 查询和筛选 {#query-and-filter-hidden}
      ...
      + [使用多对多关系进行查询 - 隐藏](workflow/using/querying-using-many-to-many-relationship.md)
      + [添加明细列表类型计算字段 - 隐藏](workflow/using/adding-enumeration-type-calculated-field.md)
      + [创建筛选条件 - 隐藏](workflow/using/creating-a-filter.md)
   ...
   + 高级管理 {#advanced-management}
      ...
      + [JavaScript 脚本和模板 - 隐藏](workflow/using/javascript-scripts-and-templates.md)
      + [工作流中的 JavaScript 代码示例 - 隐藏](workflow/using/javascript-in-workflows.md)
      + [访问外部数据库 - 隐藏](workflow/using/accessing-an-external-database-fda.md)
