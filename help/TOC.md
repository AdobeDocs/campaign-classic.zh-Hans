...
+ Getting Started {#getting-started}
   ...
   + 连接器 {#connectors}
      ...
      + [访问外部数据库](platform/using/accessing-an-external-database.md)
...
+ 发送消息 {#sending-messages}
   ...
   + 发送推送通知 {#sending-push-notifications}
      ...
      + [设置移动应用程序渠道](delivery/using/setting-up-mobile-app-channel.md)
...
+ 报告 {#reporting}
   ...
   + 分析人群 {#analyzing-populations}
      ...
      + [使用分析报告](reporting/using/processing-a-report.md)
...
+ Integrating with Adobe Experience Cloud {#integrating-with-adobe-experience-cloud}
   ...
   + 通过Adobe ID连接 {#connecting-via-an-adobe-id}
      ...
      + [配置IMS](integrations/using/configuring-ims.md)
      + [实施IMS](integrations/using/implementing-ims.md)
