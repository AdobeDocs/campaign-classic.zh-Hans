...
1. 对于剩余的重定向选件，请按照相同的步骤操作。 有关详细信息，请参见此 [ 页面](https://docs.adobe.com/help/en/target/using/experiences/offers/offer-redirect.html)。
...
## 在{#preview-send-email}Campaign Classic中预览和发送电子邮件
