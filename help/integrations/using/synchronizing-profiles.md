...
1. 确认收件人的姓名已在Campaign Standard中更新。 要了解在何处查找Campaign Standard中的用户档案，请参阅 [导航基础知识](https://experienceleague.adobe.com/docs/campaign-standard/using/getting-started/discovering-the-interface/interface-description.html?lang=zh-Hans).
...
1. 转到Campaign Standard，然后打开收件人的用户档案详细信息。 确认复选框显示在 **[!UICONTROL No longer contact (by any channel)]**. 要了解在何处查找Campaign Standard中的用户档案，请参阅 [导航基础知识](https://experienceleague.adobe.com/docs/campaign-standard/using/getting-started/discovering-the-interface/interface-description.html?lang=zh-Hans).
