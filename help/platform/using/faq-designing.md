...
# 消息设计常见问题解答 {#design-messages-faq}
...
[单击此处了解更多信息](https://docs.campaign.adobe.com/doc/AC/getting_started/EN/deliveryBestPractices.html)。
...
通过 Adobe Campaign 投放的消息可通过几种不同的方式进行个性化，涉及消息的内容或外观。根据基于收件人用户档案的特定标准，可以将这些方式结合使用。一般而言，Adobe Campaign 允许您：

* 个性化消息的格式。[单击此处了解更多信息](../../delivery/using/defining-the-email-content.md#message-content)。
