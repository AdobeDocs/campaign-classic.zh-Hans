...
1. 单击 **[!UICONTROL New]** 或右键单击模板列表并选择 **[!UICONTROL New]** 中。
1. 输入假设验证标签。
...
1. 如果为 **[!UICONTROL Offer]** 类型假设，您可以启用 **[!UICONTROL Update offer proposition status]** 选项：在这种情况下，选择要更改的选件建议的状态。
...
模板的 **[!UICONTROL General]** 选项卡，可指定常规模板选项。 可用字段包括：
...
* **[!UICONTROL Hypothesis type]**:允许您确定模板是否应用于有关投放或选件的假设验证。
   ...
   >[!NOTE]
   >
   >如果模板适用于选件，则 **[!UICONTROL Update offer proposition status]** 选项 **[!UICONTROL Transactions]** 选项卡。
...
* **[!UICONTROL Channel]**:您可以选择特定渠道，或通过选择 **[!UICONTROL All channels]** 中。 如果为特定渠道配置模板，则在创建假设验证时，可以自动按渠道过滤投放。 [了解详情](creating-hypotheses.md)
...
模板的 **[!UICONTROL General]** 选项卡中，您可以指定假设验证执行参数。 可用选项如下：
...
此选项卡包含各种字段和表，用于保存收件人反应在交易记录方面的历史记录。 请参阅 [部分](../../configuration/using/about-schema-reference.md) 有关响应管理专用表的详细信息。

* **[!UICONTROL Schema (reaction log storage)]**:选择收件人反应表。 Adobe Campaign中现成的表格是 **NmsRemaMatchRcp**.
...
* **过滤事务**:在 **[!UICONTROL Scope]** 选项卡，可以根据假设配置过滤器。 操作步骤：
...
* **按收件人筛选**:在 **[!UICONTROL Scope]** 选项卡，您可以将假设限制为链接到消息的任何信息（投放、收件人、电子邮件地址、服务等）：
...
在本例中，我们将针对直邮类型投放创建假设验证模板。 事务表(**购买** 在本例中)，假设将基于的包含链接到文章或产品的购买行。 我们希望配置我们的模型，以在购买表中创建关于文章或产品的假设验证。
...
1. 在 **[!UICONTROL Transactions]** 选项卡上，选择收件人反应表。

   ![](assets/response_hypothesis_model_example_006.png)

1. 在 **[!UICONTROL Transactions schema]** 字段，选择购买表。

   ![](assets/response_hypothesis_model_example_007.png)

1. 在 **[!UICONTROL Querying schema]** 字段。
...
1. 在 **[!UICONTROL Scope]** ，单击 **[!UICONTROL Edit query]** 来过滤假设。

   ![](assets/response_hypothesis_model_example_011.png)

   这样创建的模板允许您对购买表中的产品或文章运行假设验证。

1. 单击 **[!UICONTROL Save]** 来记录模板。
