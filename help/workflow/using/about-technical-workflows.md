...
有关如何监控技术工作流的更多信息，请参阅[专述章节](../../workflow/using/monitoring-technical-workflows.md)。
...
| **计算Twitter统计** (statsTwitter) | 社交网络（社交营销） | 此工作流会计算与Twitter上的转推和访问次数关联的统计资料。 |
...
| **LINE V2访问令牌更新** (updateLineV2AccessToken) | LINE 渠道 | 此工作流将刷新LINE V2的访问令牌。 |
...
| **同步Twitter页面** (syncTwitter) | 社交网络（社交营销） | 此工作流会在每天早上7点将Twitter关注者导入Adobe Campaign。 |
| **任务通知** (taskMgt) | 营销资源(MRM) | 利用此工作流，可发送与营销活动中的任务相关的通知消息。 |
...
| **更新收件箱渲染的种子网络** (updateRenderingSeeds) | 收件箱呈现(IR) | 此工作流会更新用于收件箱呈现的电子邮件地址，并且仅在HTTPS端口为deliverability.neolane.net打开时才可正常使用。 |
