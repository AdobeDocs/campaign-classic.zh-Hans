...
1. 双击 **[!UICONTROL List update]** 活动并选择 **[!UICONTROL Generate an outbound transition]** 选项。
   ...
   然后，您可以将生成的收件人从Adobe Campaign导出到Adobe Experience Cloud。 Adobe Target例如，您可以通过添加 **[!UICONTROL Update shared audience]** 活动到工作流。 有关更多信息，请参阅 [导出受众](../../integrations/using/importing-and-exporting-audiences.md#exporting-an-audience).
