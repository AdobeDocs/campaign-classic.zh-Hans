...
探索在中监控Campaign流程的其他方法 [此页面](../../production/using/monitoring-guidelines.md).
...
>[!NOTE]
>
>除了 **工作流热图**&#x200B;中，您可以创建一个工作流，用于监视一组工作流的状态并向主管发送定期消息。 有关详细信息，请参见 [专用部分](supervising-workflows.md).
