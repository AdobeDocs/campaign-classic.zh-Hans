...
默认情况下，下面详述的工作流随&#x200B;**营销资源(MRM)**&#x200B;模块一起安装。 有关此模块的详细信息，请参阅此[部分](../../campaign/using/designing-marketing-campaigns.md)。
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> 此工作流管理链接到营销资源审批和发布的通知。<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td> <span class="uicontrol">论坛流程</span> <br /> </td> 
