...
subfeature_v2: id: b5852c32-876b-41ae-92a7-9f588865ae52id: fcb46c0f-76e1-48bc-9dd0-fcf9d97526cf
...
在数据分段操作过程中，定位键将映射到筛选维度。 通过定向维度，您可以定义操作定向的群体：收件人、合同受益人、操作员、订阅者等。通过筛选维度，可根据特定条件选择群体：合同持有者、新闻稿订阅者等。
