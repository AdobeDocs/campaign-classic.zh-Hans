...
安装事务型消息包时，要采取几个预防措施。 Adobe建议您先在测试环境中工作，然后再投入生产。 您还需要具有兼容的Adobe Campaign许可证。 有关更多信息，请联系您的Adobe客户经理。
...
要在计算机上安装控制实例，请通过&#x200B;**[!UICONTROL Transactional message control]** > **[!UICONTROL Tools]** > **[!UICONTROL Advanced]**&#x200B;菜单选择&#x200B;**[!UICONTROL Import package]**&#x200B;包。 有关详细信息，请参阅[安装Campaign Classic标准包](../../installation/using/installing-campaign-standard-packages.md)。
...
要在计算机上安装执行实例，请通过&#x200B;**[!UICONTROL Transactional message execution]** > **[!UICONTROL Tools]** > **[!UICONTROL Advanced]**&#x200B;菜单选择&#x200B;**[!UICONTROL Import package]**&#x200B;包。 有关详细信息，请参阅[安装Campaign Classic标准包](../../installation/using/installing-campaign-standard-packages.md)。
...
>[!IMPORTANT]
>
>在安装事务型消息包之前，必须添加投放渠道（移动渠道、移动应用程序渠道等）。
...
1. 使用包导入助手(**)安装所需的频道，例如** Mobile频道&#x200B;**[!UICONTROL Tools > Advanced > Import package... > Adobe Campaign Package]**。
1. 执行文件导入(**[!UICONTROL Tools > Advanced > Import package... > File]**)，并选择&#x200B;**datakitnms &#x200B;**`[Your language]`**packagemessageCenter.xml**&#x200B;文件。
1. 在&#x200B;**[!UICONTROL XML content of the data to import]**&#x200B;中，仅保留与所添加渠道对应的投放模板。 例如，如果您添加了&#x200B;**移动渠道**，则仅保留与&#x200B;**(smsTriggerMessage)相对应的**&#x200B;实体&#x200B;**[!UICONTROL Mobile transactional message]**&#x200B;元素。 如果您已添加&#x200B;**移动应用程序渠道**，请仅保留&#x200B;**iOS事务型消息** (iosTriggerMessage)和&#x200B;**Android事务型消息** (androidTriggerMessage)。
...
1. 使用以下配置在您的&#x200B;**[!UICONTROL External database]**&#x200B;执行&#x200B;**实例中创建**&#x200B;外部帐户：
...
1. 使用以下配置在您的&#x200B;**[!UICONTROL External Database]**&#x200B;营销&#x200B;**实例中创建一个**&#x200B;帐户。
...
1. 使用以下配置在&#x200B;**[!UICONTROL Execution instance]** marketing **实例中创建**&#x200B;外部帐户以创建数据同步工作流：
