...
## 数据库清理工作流{#tasks-carried-out-by-the-database-cleanup-workflow}执行的任务
...
### 清理要删除或回收的{#cleanup-of-deliveries-to-be-deleted-or-recycled}投放
...
#### 使用中间源{#deliveries-using-mid-sourcing}的投放
