...
有关索引的详细信息，请参阅“索引 [字段](../../configuration/using/database-mapping.md#indexed-fields) ”部分。
...
元素部分提供了完整的属性 [`<attribute>` 列表](../../configuration/using/elements-and-attributes.md#attribute--element) 。 以下是一些更常用的属性：
