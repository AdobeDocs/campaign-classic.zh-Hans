...
Adobe Campaign附带预定义的数据模型。 本节详细介绍了Adobe Campaign数据模型的内置表及其交互。
...
这组表链接到移动应用 **渠道**，该允许通过应用向iOS和Android终端发送个性化通知。 有关此方面的详细信息，请参 [阅关于移动应用渠道](../../delivery/using/about-mobile-app-channel.md)。
