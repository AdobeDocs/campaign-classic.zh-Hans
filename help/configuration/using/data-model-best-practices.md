...
要更好地了解活动内置表及其交互，请参阅[Campaign Classic数据模型](../../configuration/using/about-data-model.md)部分。
...
默认情况下，自定义序列的值将介于+1,000到+2.1BB之间。 从技术上讲，通过启用负ID，可获得全范围4BB。 这应当谨慎使用，当从负数到正数时，将丢失一个id:在生成的SQL查询中，记录0通常被Adobe Campaign Classic忽略。
