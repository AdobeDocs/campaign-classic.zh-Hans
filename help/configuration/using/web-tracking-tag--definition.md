...
<table>
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td>
                              <p>如果没有会话Cookie，则使用的投放标识符。 该值以十六进制表示。
                              </p> 
                           </td> 
                        </tr>
                        <tr>
                           ...
                           <td>
                              <p>用于标识Internet用户的参数。 此参数的格式为“name=value”，其中名称是收件人架构的字段。 此参数的优先级高于会话Cookie中包含的标识符。
                              </p> 
                           </td> 
                        </tr> 
                     </tbody>  
...
* 将URL插入 **&quot;src&quot;** HTML的属性 **`<img>`** 标记包含在要跟踪的网页中。
