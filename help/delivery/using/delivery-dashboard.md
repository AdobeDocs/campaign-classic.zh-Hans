...
>
>本页介绍了针对混合部署和内部部署的特定于&#x200B;**Campaign Classic v7的自定义**。

监测投放对于确保营销活动有效并接触到客户至关重要。

有关使用投放仪表板选项卡访问投放列表和监控投放的全面信息，请参阅Campaign UI文档中的[Campaign v8监控投放](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/monitor/delivery-dashboard){target="_blank"}。
...
* [退回邮件配置](understanding-delivery-failures.md)（v7混合/内部部署）
