...
Adobe Campaign现在可以升级，以便使用&#x200B;**Enhanced MTA** （邮件传输代理），这是一个高性能的电子邮件投放引擎。

增强的MTA包括更智能的退回处理和自动投放能力优化功能，可帮助发件人实现并维持最佳的收件箱投放率。
...
有关重试的详细信息，请参阅&#x200B;**投放发送** > **配置重试**&#x200B;下的此[页面](communication-channels.md)。
...
有关有效期的更多信息，请参阅&#x200B;**投放发送** > **定义有效期**&#x200B;下的此[页面](communication-channels.md)。
