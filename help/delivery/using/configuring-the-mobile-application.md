...
>
>如果不是，请参阅[此页](https://developer.apple.com/documentation/usernotifications)。
...
1. 确保通过SDK在Adobe Campaign和应用程序代码中定义相同的&#x200B;**[!UICONTROL Integration key]**。 有关此内容的详细信息，请参阅：[将活动SDK集成到移动应用程序](../../delivery/using/integrating-campaign-sdk-into-the-mobile-application.md)。 此集成密钥是每个应用程序特有的，它允许您将移动应用程序链接到Adobe Campaign平台。

   >[!NOTE]
   >
   > **[!UICONTROL Integration key]**&#x200B;可以完全自定义字符串值，但必须与SDK中指定的值完全相同。
...
1. 选择 **[!UICONTROL Authentication mode]**。请注意，以后您始终可以在移动应用程序的&#x200B;**[!UICONTROL Certificate]**&#x200B;选项卡中更改身份验证模式。
   ...
   * **[!UICONTROL Token-based authentication]**:填写连接设置 **[!UICONTROL Key ID]**, **[!UICONTROL Team ID]** 然 **[!UICONTROL Bundle ID]** 后单击选择p8证书 **[!UICONTROL Enter the private key]**。有关&#x200B;**[!UICONTROL Token-based authentication]**&#x200B;的详细信息，请参阅[Apple文档](https://developer.apple.com/documentation/usernotifications/setting_up_a_remote_notification_server/establishing_a_token-based_connection_to_apns)。

   >[!NOTE]
   >
   > Adobe建议对iOS配置使用&#x200B;**[!UICONTROL Token-based authentication]**，因为此身份验证模式更加安全，不会绑定到证书过期。

   ![](assets/nmac_ios_4.png)

1. 单击&#x200B;**[!UICONTROL Test the connection]**&#x200B;可确保成功。
...
1. 在&#x200B;**[!UICONTROL Delivery template]**&#x200B;下拉列表中选择&#x200B;**[!UICONTROL Deliver on iOS (ios)]**。 将&#x200B;**[!UICONTROL Label]**&#x200B;添加到您的投放。
...
1. 在&#x200B;**[!UICONTROL Service]**&#x200B;下拉框中，选择之前创建的服务，然后选择要目标的应用程序并单击&#x200B;**[!UICONTROL Finish]**。
