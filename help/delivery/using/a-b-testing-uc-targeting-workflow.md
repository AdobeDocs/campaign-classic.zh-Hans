...
1. 如果尚未创建活动，请创建此类应用程序（有关详细信息，请参阅此[部分](../../campaign/using/setting-up-marketing-campaigns.md#creating-a-campaign)）。
...
您现在可以配置填充示例(请参阅[步骤2:配置填充示例](../../delivery/using/a-b-testing-uc-population-samples.md))。
