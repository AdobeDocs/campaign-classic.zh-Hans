...
>[!NOTE]
>
> 对于混合和托管架构，必须在所有服务器上安装包，包括[中间源服务器](../../installation/using/mid-sourcing-server.md)和[执行实例](../../message-center/using/configuring-instances.md#execution-instance)。
...
1. 安装&#x200B;**[!UICONTROL AMP support]**&#x200B;包。 请参阅[安装Campaign内置包](../../installation/using/installing-campaign-standard-packages.md)。
...
您还可以查阅Gmail[文档的](https://developers.google.com/gmail/ampemail/tips)提示和已知限制。
...
1. 测试后，您可以通过向相关电子邮件提供商注册以将您的发件人域添加到，将投放或促销活动作为AMP for Email计划的一部分发送。 请参阅向电子邮件提供商[注册以传递AMP电子邮件](#delivering-amp-emails-by-registering)。
...
对于Gmail，您必须先将正在使用的发件人地址添加到Adobe Campaign中，以发送您定位的Gmail帐户。
...
您可以尝试通过向支持的电子邮件提供商进行注册来发送动态电子邮件，以便将您的发件人域添加到。
