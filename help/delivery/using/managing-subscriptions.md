...
* 在中输入服务的名称 **[!UICONTROL Label]** 字段并选择投放渠道：电子邮件、移动设备、Facebook、X(以前称为Twitter)或移动设备应用程序。

  >[!NOTE]
  >
  >facebook和X订阅详情，请参见 [本节](../../social/using/about-social-marketing.md). 有关移动应用程序订阅的详情，请参见 [关于移动应用程序渠道](about-mobile-app-channel.md).
