...
个性化块可通过Adobe Campaign资源管理器的&#x200B;**[!UICONTROL Resources > Campaign Management > Personalization blocks]**&#x200B;节点进行访问。 默认情况下，有几个块可用(请参阅[现成个性化块](#out-of-the-box-personalization-blocks))。

您能够定义新的基块，从而优化投放个性化。 有关详细信息，请参阅[定义自定义个性化块](#defining-custom-personalization-blocks)。

>[!NOTE]
>
>个性化块也可从&#x200B;**[!UICONTROL Digital Content Editor (DCE)]**&#x200B;中获取。 有关详细信息，请参见[此页面](../../web/using/editing-content.md#inserting-a-personalization-block)。
...
1. 从列表中选择一个个性化区块(列表显示10个最后使用的区块)，或单击&#x200B;**[!UICONTROL Other...]**&#x200B;菜单访问完整列表。
...
您可以在投放内容中包含个性化块的源代码。 为此，请在选择时选择&#x200B;**[!UICONTROL Include the HTML source code of the block]**。

![](assets/s_ncs_user_personalized_block05.png)

HTML源代码将插入投放内容中。 例如，**[!UICONTROL Greetings]**&#x200B;个性化区块显示如下：
...
1. 在邮件正文中插入个性化块。 为此，请单击消息内容中的个性化字段图标，然后选择&#x200B;**[!UICONTROL Include]**&#x200B;菜单。
...
* **[!UICONTROL Formatting function for proper nouns]** :生成 **[!UICONTROL toSmartCase]** Javascript函数，该函数将每个单词的第一个字母更改为大写。此块必须插入投放的源代码中的&#x200B;**`<script>...</script>`**&#x200B;标记中。
...
* **[!UICONTROL Style of content emails]** 和 **[!UICONTROL Notification style]** :生成使用预定义的HTML样式设置电子邮件格式的代码。这些块必须插入投放的源代码（位于&#x200B;**[!UICONTROL ...]**&#x200B;部分）中的&#x200B;**`<style>...</style>`**&#x200B;标记中。
* **[!UICONTROL Offer acceptance URL in unitary mode]** :插入一个URL，用于将交互优惠设 **[!UICONTROL Accepted]** 置为( [请参阅](../../interaction/using/offer-analysis-report.md)此部分)。
